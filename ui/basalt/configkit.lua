...
M.GLOSSARY = {
  ...
  modes = {
    ...
    lines = {
      ...
      "LDG: reduced", "caps for", "landing.",
      "DRN: tilt-to", "fly, no", "translate.",
      "CPL/DCPL are", "MASTER modes",
      "(drift law,", "not flight", "mode).",
      "CPL: coupled", "master.",
      "Arrests idle", "drift on", "release",
      "(holds", "station).",
      "DCPL: drift", "coasts freely",
      "(alt/att", "still held).",
    },
  },
  alt = {
