...
t.test("attitude detuned ~2x with ki off (CoM centered)", function()
  t.near(T.gains.pitch.kp, 0.12, 1e-9); t.near(T.gains.pitch.kd, 0.25, 1e-9); t.eq(T.gains.pitch.ki, 0)
  t.near(T.gains.roll.kp, 0.12, 1e-9); t.eq(T.gains.roll.ki, 0)
end)
