...
t.test("SPD defaults to SAS and rounds", function()
  t.eq(R.spd({ sas = 12.2 }), "SPD 12 SAS")
  t.eq(R.spd({}), "SPD --- SAS")
end)

t.test("SPD TAS needs a good fix", function()
  t.eq(R.spd({ spdSource = "TAS", tas = 34.7, gpsFixOk = true }), "SPD 35 TAS")
